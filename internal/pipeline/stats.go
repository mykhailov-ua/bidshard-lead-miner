...
type RoundStats struct {
	...
	RejectedNoReachableContact int
...
func (s *RoundState) Snapshot(roundID string, duration time.Duration) RoundStats {
	return RoundStats{
		...
		RejectedNoReachableContact: int(s.RejectedNoReachableContact.Load()),
		...
		RejectedStore:          int(s.RejectedStore.Load()),
		Leads:                  s.Leads(),
	}
}
