...
type EntityDoc struct {
	...
	HeatScoreRound     int                `bson:"heat_score_round,omitempty" json:"heat_score_round,omitempty"`
	...
	SemanticCluster    string             `bson:"semantic_cluster,omitempty" json:"semantic_cluster,omitempty"`
	ClassifyForce      bool               `bson:"classify_force,omitempty" json:"classify_force,omitempty"`
	...
	ReviewSuggestions  []ReviewSuggestion `bson:"review_suggestions,omitempty" json:"review_suggestions,omitempty"`
}

// ReviewSuggestion is an ops-pending entity graph action from Gemini link review.
type ReviewSuggestion struct {
	PeerEntityID string    `bson:"peer_entity_id" json:"peer_entity_id"`
	SharedDomain string    `bson:"shared_domain,omitempty" json:"shared_domain,omitempty"`
