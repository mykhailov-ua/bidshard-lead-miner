...
func newSourcesCmd() *cobra.Command {
	...
	cmd.AddCommand(&cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			fmt.Fprintln(cmd.OutOrStdout(), "Set source: parser scan --source=forum   or   PARSER_SOURCE=forum")
			fmt.Fprintln(cmd.OutOrStdout(), "Telegram is separate: parser telegram")
		},
	})
